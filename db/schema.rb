...
ActiveRecord::Schema.define(version: 2020_06_28_150137) do

  create_table "boards", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title", default: "", null: false, collation: "utf8mb4_general_ci"
    t.string "content", default: "", null: false, collation: "utf8mb4_general_ci"
  ...
  create_table "comments", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "board_id"
    t.string "comment", default: "", null: false, collation: "utf8mb4_general_ci"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
